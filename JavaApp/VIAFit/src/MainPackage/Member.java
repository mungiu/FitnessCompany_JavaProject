...
public class Member implements Serializable
{
   ...
   /**
    * Sets the members membership start date.
    * 
    * @param memberSince
    *           is what the members membership start date is set to.
    */
   ...
   public String toString()
   {
      ...
      else if (email.length() >= 8 && email.length() < 16)
      {
         ...
         emailTab = "\t\t\t";
      String str = "<html><pre style='font-size:11px'>" + name + nameTab + email
            + emailTab + phoneNumber + "\t\t" + memberSince + "\t\t" + memberID
            + "</pre></html>";
      return str;
   }
}
