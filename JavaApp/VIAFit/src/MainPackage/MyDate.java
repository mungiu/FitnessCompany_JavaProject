...
public class MyDate implements Serializable
{
    ...
    * 
    * @param month
    *           will be set as month in MyDate
    */
   ...
   public String dayOfWeek()
   {
      ...
      day1 = (((day + ((13 * (monthTemp + 1))) / 5)) + yearTemp % 100
            + ((yearTemp % 100) / 4) + ((yearTemp / 100) / 4)
            + (5 * (yearTemp / 100))) % 7;
   ...
   public static MyDate today()
   {
      ...
      return new MyDate(cal.get(GregorianCalendar.DATE),
