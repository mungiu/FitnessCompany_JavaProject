...
public class mainGUI extends JFrame
{
					...
					} else
					{
						for (int i = 0; i < fileAdapter.getMembersList().getMembersList().size(); i++)
						{
							if (fileAdapter.getMembersList().getMembersList().get(i).getName().toLowerCase()
									...
									|| fileAdapter.getMembersList().getMembersList().get(i).getPhoneNumber()
											.contains(search.getText())
									|| (checkIfOnlyInts(search.getText())
											&& fileAdapter.getMembersList().getMembersList().get(i)
													.getMemberID() == Integer.parseInt(search.getText() + "")))
							{
					...
					} else
					{
						for (int i = 0; i < fileAdapter.getInstructorsList().getInstructorsList().size(); i++)
						{
							if (fileAdapter.getInstructorsList().getInstructorsList().get(i).getName().toLowerCase()
									.contains(search.getText().toLowerCase())
									|| (checkIfOnlyInts(search.getText())
											&& fileAdapter.getInstructorsList().getInstructorsList().get(i)
													.getInstructorID() == Integer.parseInt(search.getText() + "")))
							{
					...
					} else
					{
						for (int i = 0; i < fileAdapter.getEventsList().getEventsList().size(); i++)
						{
							if (fileAdapter.getEventsList().getEventsList().get(i).getClassName().toLowerCase()
									...
									|| (checkIfOnlyInts(search.getText()) && fileAdapter.getEventsList().getEventsList()
											.get(i).getEventID() == Integer.parseInt(search.getText() + "")))
							{
	...
	public void setTopLabel(String type)
	{
		...
		{
			String eventString = "<html><pre style='font-size:11px'>"
					+ "Member name\t        Email\t                  Phone number\t          Sign up date\t           ID"
					+ "</pre></html>";
		...
		{
			String eventString = "<html><pre style='font-size:11px'>"
					+ "Instructor name\t\t   ID\t\t  Qualified for:</pre></html>";
			aboveBigInfo.setText(eventString);
		}
		if (type.equals("Event"))
		{
			String eventString = "<html><pre style='font-size:11px'>"
					+ "Event name\t     Type\t    Max members\t\t  Date\t\t           Time" + "</pre></html>";
			aboveBigInfo.setText(eventString);
		}
	}
	 ...
	 * 
	 * @param type
	 *            A string used to tell what data should be shown
	 */
	...
	public mainGUI()
	{
		...
		aboveOngoing = new JLabel(
				"<html><pre style='font-size:11px'>" + "Event name\tAttending members" + "</pre></html>");
		aboveOngoing.setPreferredSize(new Dimension(330, 17));
		aboveUpcoming = new JLabel(
				"<html><pre style='font-size:11px'>" + "Event name\tAttending members" + "</pre></html>");
		...
		// setting borders to see how it looks in GUI ----------------------- Delete
		// later!
